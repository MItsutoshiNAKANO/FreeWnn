/*
 * $Id: functions.c,v 1.1.1.1 2000-01-16 05:07:51 ura Exp $
 */
...
int call_redraw_line_yincod(x, add)
int x, add;
{
    int hantentmp;
    int marktmp;
