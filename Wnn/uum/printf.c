/*
 * $Id: printf.c,v 1.1.1.1 2000-01-16 05:07:51 ura Exp $
 */
     ...
     FILE *file;
{
  ...
  len = (*code_trans[(file_code<<2) | tty_c_flag])
	(buf , buf2 , strlen(buf2) + 1);
...
flushw_buf()
{
    ...
    len=(*code_trans[(internal_code<<2)|tty_c_flag])
	(buf , w_buf , sizeof(w_char) * w_maxbuf);
