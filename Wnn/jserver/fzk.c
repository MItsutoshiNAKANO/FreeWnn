/*
 *  $Id: fzk.c,v 1.3 2001-06-14 17:55:36 ura Exp $
 */
...
static int fzk_ck_vector(), bittest(), get_decimal(),
  check_eof(), get_hexsa(), get_string(), check_eof(), kng_ckvt();
...
*/
#ifndef NO_FZK
static struct fzkentry *bsrch(key_yomi)
w_char	*key_yomi;
{
