/*
 * $Id: do_env.c,v 1.1.1.1 2000-01-16 05:07:45 ura Exp $
 */
...
static int conn1(), add_env_to_client(), find_env_by_name(),
  disconnect_last_sticky(), find_env_in_client();
